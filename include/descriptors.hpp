...
public:
	 ...
	 */
	void add(std::unique_ptr<FileReaderDescriptor> d);
...
public:
	...
	/**
	 * \brief Set of available descriptors for AudioReaders.
	 */
...
protected:
	...
	{
		descriptors_.add(std::move(d));
	}

private:

	static DescriptorSet descriptors_;
